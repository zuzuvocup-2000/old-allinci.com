	...
	<div class="row wrapper border-bottom white-bg page-heading">
		<div class="col-lg-12">
			...
			<ol class="breadcrumb">
				...
				<li class="active"><strong>Thêm mới nhóm hỗ trợ</strong></li>
			</ol>
		</div>
	</div>
	<!-- --------------------------- -->
				...
				<div class="col-lg-6">
					<div class="ibox-content">
						<div class="form-row mb10">
							...
							<input type="hidden" name="canonical" class="canonical" value="" data-flag="0">
						</div>
						...
						<div class="form-row">
							...
							<div class="setup-display uk-clearfix col-lg-6 pdl0 mgb0">
								<div class="i-checks" style="width: 100%;"><span style="color:#000;"><input type="radio" <?php echo (null == $this->input->post('publish') || $this->input->post('publish') == '1') ? 'checked' : '' ?> class="popup_gender_1 gender" value="1"  name="publish">Hiển thị</span></div>
							</div>
