							...
							<div class="form-row col-lg-6">
								...
								<div class="outer">
									<div class="uk-flex uk-flex-middle">
										<?php echo form_input('canonical', htmlspecialchars_decode(html_entity_decode(set_value('canonical'))), 'class="form-control bdl1" placeholder="" autocomplete="off" data-flag="0" ') ;?>
									</div>
								</div>
							</div>
						</div>
