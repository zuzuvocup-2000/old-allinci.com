<div id="page-wrapper" class="gray-bg dashbard-1 fix-wrapper">
	...
	<div class="row wrapper border-bottom white-bg page-heading">
		<div class="col-lg-10">
			<h2>Thêm mới nhóm thư viện</h2>
			<ol class="breadcrumb">
				<li>
					<a href="<?php echo site_url('admin'); ?>">Home</a>
				</li>
				<li class="active"><strong>Thêm mới nhóm thư viện</strong></li>
			</ol>
		</div>
	</div>
							...
							<div class="row">
								...
								<div class="col-lg-12">
									<div class="form-row" style="margin-top:20px;">
										<?php echo form_dropdown('layoutid', $this->configbie->data('layout'), set_value('layoutid'), 'class="form-control m-b select3"');?>
									</div>
								</div>
							</div>
						</div>
