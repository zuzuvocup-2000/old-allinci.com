		...
		<div class="wrapper wrapper-content animated fadeInRight">
			...
			<div class="row">
				<div class="col-lg-8 clearfix">
							...
							<div class="row mb15">
								<div class="col-lg-6">
									<div class="form-row">
										...
										<div class="form-row">
											<?php echo form_dropdown('catalogueid', $this->nestedsetbie->dropdown(), set_value('catalogueid'), 'class="form-control m-b select3 layout"');?>
										</div>
									</div>
								</div>
								<div class="col-lg-6">
					...
					<script type="text/javascript">
						var layoutid = <?php echo (int)$this->input->post('catalogueid'); ?>;
					</script>
								...
								<div class="col-lg-12">
									<div class="wrap-direct" style="margin-bottom:10px;">
										<span href="" style="margin-right:10px;margin-bottom:10px;" title="" class="video-direct uk-flex uk-flex-middle">
											<input class="choose_video_type" style="margin-top:0;margin-right:5px;" type="radio" id="video-direct" name="video_type" value="0" />
											<label for="video-direct" style="margin:0;font-weight:normal;cursor:pointer">Upload trực tiếp</label>
										</span>
										<?php echo form_input('video_link', set_value('video_link'), 'class="form-control" placeholder="Click để upload" disabled="disabled" onclick="openKCFinderMedia(this, \'media\');" id="video-link" autocomplete="off"');?>
									</div>
									
									<div class="wrap-iframe">
										<span href="" style="margin-right:10px;margin-bottom:10px;" title="" class="video-iframe uk-flex uk-flex-middle">
											<input checked style="margin-top:0;margin-right:5px;" type="radio" id="iframe-video"  name="video_type" class="choose_video_type" value="1" />
											<label for="iframe-video" style="margin:0;font-weight:normal;cursor:pointer">Mã nhúng</label>
										</span>
										<?php echo form_textarea('video_iframe', htmlspecialchars_decode(html_entity_decode(set_value('video_iframe'))), 'class="form-control" id="video-iframe" placeholder="Dán mã nhúng vào đây" autocomplete="off"');?>
									</div>
								</div>
					...
					<div class="ibox mb20">
						...
						<div class="ibox-content">
							<div class="row">
								<div class="col-lg-12">
									<div class="form-row">
										<span class="text-black mb15">Quản lý thiết lập hiển thị cho bản ghi này.</span>
