<div id="page-wrapper" class="gray-bg dashbard-1 fix-wrapper">
	...
	<div class="row wrapper border-bottom white-bg page-heading">
		<div class="col-lg-10">
			<h2>Thêm mới thuộc tính</h2>
			<ol class="breadcrumb">
				<li>
					<a href="<?php echo site_url('admin'); ?>">Home</a>
				</li>
				<li class="active"><strong>Thêm mới thuộc tính</strong></li>
			</ol>
		</div>
	</div>
				...
				<div class="col-lg-4">
					<div class="ibox mb20">
						...
						<div class="ibox-content">
							<div class="row mb15">
								<div class="col-lg-12">
									...
									<?php echo form_dropdown('catalogueid', 
										...
										set_value('catalogueid',$this->input->get('catalogueid')) ,'class="form-control input-sm perpage select3 catalogueid" '); ?>
									</div>
								</div>
							</div>
							<div class="row mb15 color" style="display: none">
								<div class="col-lg-12">
									<div class="form-row back-change">
										...
										<div class="uk-flex uk-flex-middle uk-flex-space-between">
				                            <input type="text" autocomplete="off"  class="form-control demo1 m-r" name="color" value="" />
				                            <div data-color="rgb(255, 255, 255)" id="demo_apidemo" class="btn btn-white btn-block colorpicker-element" style="width: 13px; height: 34px"></div>
				                            <!-- 
							...
							<div class="row mb15 price_range" style="display: none">
								<div class="col-lg-12">
									<div class="form-row back-change">
										<div class="uk-flex uk-flex-middle uk-flex-space-between">	
											<span class="m-r" >Từ </span> 
				                            <input type="text" autocomplete="off"  class="form-control int m-r text-right" name="start_price" value="" />
				                            <span class="m-r">đến </span> 
				                          	<input type="text" autocomplete="off"  class="form-control int text-right " name="end_price" value="" />
										</div>
									</div>
								</div>
							</div>
