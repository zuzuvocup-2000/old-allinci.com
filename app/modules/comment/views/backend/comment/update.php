...
<div id="page-wrapper" class="gray-bg dashbard-1 fix-wrapper">
	...
	<form method="post" action="" class="form-horizontal box" id="comment-update_form" >
		<div class="row wrapper border-bottom white-bg page-heading">
			<div class="col-lg-10">
				<h2>Cập nhật comment</h2>
				<ol class="breadcrumb">
					<li>
						<a href="<?php echo site_url('admin'); ?>">Home</a>
					</li>
					<li class="active"><strong>Cập nhật comment</strong></li>
				</ol>
			</div>
		</div>
		<script type="text/javascript">
			var module = "<?php echo (null != $this->input->post('module'))? $this->input->post('module') : $detailComment['module'];?>";
			var object = <?php echo (null != $this->input->post('detailid'))? $this->input->post('detailid') : $detailComment['detailid'];?>;
		</script>
			...
			<div class="row">
				<div class="col-lg-8 clearfix">
							...
							<div class="row mb15">
								<div class="col-lg-6">
									<div class="form-row">
										...
										<div class="form-row">
											<?php echo form_dropdown('module', $this->myconstant->list_data('module'),  htmlspecialchars_decode(html_entity_decode(set_value('module', $detailComment['module']))), 'class="form-control m-b select3" id="module"');?>
										</div>
									</div>
								</div>
								<div class="col-lg-6">
									<?php 
										$json = base64_encode(json_encode(array($detailComment['detailid'])));
									 ?>
									<div class="form-row" data-json="<?php echo $json ?>" id="object" >
									</div>
								</div>
							</div>
							<hr>
							<div class="row mb15">
								<div class="col-lg-12">
									<div class="text-center">
										<input type="hidden" class="data-rate" name="data-rate" value="<?php echo ($this->input->post('data-rate'))? (int)$this->input->post('data-rate'): $detailComment['rate'];?>">
										<span class="rating" data-stars="5" data-default-rating="<?php echo ($this->input->post('data-rate'))? (int)$this->input->post('data-rate'): $detailComment['rate'];?>" data-rating="<?php echo ($this->input->post('data-rate'))? (int)$this->input->post('data-rate'): $detailComment['rate'];?>"></span>
									</div>
									
									<div class="text-center mt10"><span class="title-rating"><?php echo review_render(($this->input->post('data-rate'))?(int)$this->input->post('data-rate') : $detailComment['rate']);?></span></div>
								</div>
							</div>
							<hr>
							<div class="row mb15">
								<div class="col-lg-12">
									<div class="form-row">
										...
										<?php echo form_textarea('comment', htmlspecialchars_decode(html_entity_decode(set_value('comment' , $detailComment['comment']))), 'class="form-control comment" placeholder="" autocomplete="off" ');?>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="ibox mb20 album">
						...
						<div class="ibox-content">
							<?php $album = json_decode($detailComment['image'] , true);?>
							<div class="row">
								<div class="col-lg-12">
							...
							<div class="row mb15">
								<div class="col-lg-12">
									<div class="form-row">
										...
										<?php echo form_input('fullname', htmlspecialchars_decode(html_entity_decode(set_value('fullname' , $detailComment['fullname']))), 'class="form-control
							...
							<div class="row mb15">
								<div class="col-lg-12">
									<div class="form-row">
										...
										<?php echo form_input('email', htmlspecialchars_decode(html_entity_decode(set_value('email' , $detailComment['email']))), 'class="form-control
										" placeholder="" autocomplete="off" ');?>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-lg-12">
									<div class="form-row">
										...
										<?php echo form_input('phone', htmlspecialchars_decode(html_entity_decode(set_value('phone' , $detailComment['phone']))), 'class="form-control
										" placeholder="" autocomplete="off" ');?>
									</div>
								</div>
							</div>
