							...
							<div class="row mb15">
								<div class="col-lg-12 mb10">
									<div class="form-row">
										...
										<?php echo form_textarea('excerpt', htmlspecialchars_decode(html_entity_decode(set_value('excerpt'))), 'class="form-control ck-editor" id="ckDescription0" data-height="150" placeholder="" autocomplete="off"');?>
									</div>
								</div>
							</div>
						...
						<div class="ibox-content">
							<div class="row">
								<div class="col-lg-12">
									...
									<div class="form-row">
										<?php echo form_dropdown('parentid', $this->nestedsetbie->dropdown(), set_value('parentid', 0), 'class="form-control m-b select3"');?>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="ibox-content">
							<div class="row">
								<div class="col-lg-12">
									...
									<div class="form-row">
										<?php echo form_dropdown('url_view', $this->configbie->data('url_cat_view'), set_value('url_view'), 'class="form-control m-b select3"');?>
									</div>
								</div>
							</div>
						</div>
				 	...
				 	<div class="ibox mb20">
						...
						<div class="ibox-content">
							<div class="row">
								<div class="col-lg-12">
									<div class="form-row">
										<?php echo form_input('landing_link', htmlspecialchars_decode(html_entity_decode(set_value('landing_link'))), 'class="form-control" placeholder="" autocomplete="off"');?>
									</div>
								</div>
							</div>
						</div>
