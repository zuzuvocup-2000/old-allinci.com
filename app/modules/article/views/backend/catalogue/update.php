							...
							<div class="row mb15">
								<div class="col-lg-12 mb10">
									<div class="form-row">
										...
										<?php echo form_textarea('excerpt', htmlspecialchars_decode(html_entity_decode(set_value('excerpt', $detailCatalogue['excerpt']))), 'class="form-control ck-editor" id="ckDescription0" data-height="150" placeholder="" autocomplete="off"');?>
									</div>
								</div>
							</div>
								...
								<div class="col-lg-12">
									...
									<?php
										...
										if(isset($album) && is_array($album) && count($album)){
											...
											$gallery = json_decode($detailCatalogue['album'], TRUE);
										}
								...
								<div class="col-lg-12">
									<div class="google">
										...
										<div class="g-description" id="metaDescription">
											<?php echo cutnchar(($this->input->post('meta_description')) ? $this->input->post('meta_description') : (($this->input->post('description')) ? strip_tags($this->input->post('description')) : ((!empty($detailCatalogue['meta_description'])) ? strip_tags($detailCatalogue['meta_description']) :((!empty($detailCatalogue['description'])) ? strip_tags($detailCatalogue['description']): 'List of all combinations of words containing CKEDT. Words that contain ckedt letters in them. Anagrams made from C K E D T letters.List of all combinations of words containing CKEDT. Words that contain ckedt letters in them. Anagrams made from C K E D T letters.'))), 360); ?>
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="form-row mb10">
											...
											<div class="mb5">
												<small class="text-danger">- Kiểu 2 : Dịch vụ marketing ( có slide ảnh chạy trên cùng)</small>
											</div>
										</div>
										<div class="form-row">
											<?php echo form_dropdown('url_view', $this->configbie->data('url_cat_view'), set_value('url_view', $detailCatalogue['url_view']), 'class="form-control m-b select3"');?>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="ibox mb20">
						...
						<div class="ibox-content">
							<div class="row">
								<div class="col-lg-12">
									<div class="form-row">
										<?php echo form_input('landing_link', htmlspecialchars_decode(html_entity_decode(set_value('landing_link', $detailCatalogue['landing_link']))), 'class="form-control" placeholder="" autocomplete="off"');?>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="ibox mb20">
						...
						<div class="ibox-content">
							<div class="row">
								<div class="col-lg-12">
									<div class="form-row mb10">
										<small class="">Chọn <a  onclick="openKCFinderSingleImage(this);return false;"  title=""  class="upload-picture">thêm ảnh</a> hoặc chọn icon ở <a targe="_blank" href="https://fontawesome.com/v4.7.0/icons/">đây</a></small>
									</div>

									<div class="form-row">
										<?php echo form_input('icon', set_value('icon', $detailCatalogue['icon']), 'class="form-control local_result" placeholder=""  autocomplete="off"');?>
					...
					<div class="ibox mb20">
						...
						<div class="ibox-content">
							<div class="row">
								<div class="col-lg-12">
									<div class="form-row">
										<div class="avatar local_result" style="cursor: pointer;"><img src="<?php echo ($this->input->post('image')) ? $this->input->post('image') : ((!empty($detailCatalogue['image'])) ? $detailCatalogue['image'] : 'template/not-found.png'); ?>" class="img-thumbnail" alt=""></div>
