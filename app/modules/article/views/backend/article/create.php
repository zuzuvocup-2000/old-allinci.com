							...
							<div class="row mb15">
								<div class="col-lg-12">
									<div class="form-row">
										...
										<div class="form-row">
											<?php echo form_dropdown('catalogue[]', '', (isset($catalogue)?$catalogue:NULL), 'class="form-control " multiple="multiple" data-title="Nhập 2 kí tự để tìm kiếm.."  style="" id="article_catalogue"'); ?>
										</div>
									</div>
								</div>
							</div>
