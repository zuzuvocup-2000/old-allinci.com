							...
							<div class="row mb15">
								...
								<div class="col-lg-6">
									<div class="form-row">
										...
										<?php echo form_input('price', set_value('price'), 'class="form-control int" placeholder="" autocomplete="off"');?>
									</div>
								</div>
							</div>
							<div class="row mb15">
								<div class="col-lg-6">
									<div class="form-row">
										...
										<?php echo form_input('capacity', set_value('capacity'), 'class="form-control " placeholder="" autocomplete="off"');?>
									</div>
								</div>
								<?php 
							...
							<div class="row mb15">
								<div class="col-lg-6">
									<div class="form-row">
										...
										<?php echo form_input('bandwidth', set_value('bandwidth'), 'class="form-control " placeholder="" autocomplete="off"');?>
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-row">
										...
										<?php echo form_input('FPT_account', set_value('FPT_account'), 'class="form-control " placeholder="" autocomplete="off"');?>
									</div>
								</div>
							</div>
							<div class="row mb15">
								<div class="col-lg-6">
									<div class="form-row">
										...
										<?php echo form_input('mysql', set_value('mysql'), 'class="form-control " placeholder="" autocomplete="off"');?>
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-row">
										...
										<?php echo form_input('domain', set_value('domain'), 'class="form-control " placeholder="" autocomplete="off"');?>
									</div>
								</div>
							</div>
							<div class="row mb15">
								<div class="col-lg-6">
									<div class="form-row">
										...
										<?php echo form_input('sub_domain', set_value('sub_domain'), 'class="form-control" placeholder="" autocomplete="off"');?>
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-row">
										...
										<?php echo form_input('addon_domain', set_value('addon_domain'), 'class="form-control " placeholder="" autocomplete="off"');?>
									</div>
								</div>
							</div>
							<div class="row mb15">
								<div class="col-lg-6">
									<div class="form-row">
										...
										<?php echo form_input('park_domain', set_value('park_domain'), 'class="form-control" placeholder="" autocomplete="off"');?>
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-row">
										...
										<?php echo form_input('contract_time', set_value('contract_time'), 'class="form-control " placeholder="" autocomplete="off"');?>
									</div>
								</div>
							</div>
