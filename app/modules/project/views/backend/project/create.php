	...
	<div class="row wrapper border-bottom white-bg page-heading">
		<div class="col-lg-10">
			...
			<ol class="breadcrumb">
				...
				<li class="active"><strong>Thêm mới dự án</strong></li>
			</ol>
		</div>
	</div>
						...
						<div class="ibox-content">
							...
							<div class="row mb15">
								...
								<div class="col-lg-12">	
									<div class="uk-flex uk-flex-middle uk-flex-space-between">
										<label class="control-label text-left ">
											<span>Nội dung mở rộng <!-- ( Kiểu 3, 4 , 5 ) --></span>
										</label>
							...
							<div class="row mb15">
								<div class="col-lg-12">
									<div class="form-row">
										...
										<div class="form-row">
											<?php echo form_dropdown('catalogueid', $this->nestedsetbie->dropdown(), set_value('catalogueid' , 0), 'class="form-control m-b select3"');?>
										</div>
									</div>
								</div>
							</div>
							<div class="row mb15">
								<div class="col-lg-12">
									<div class="form-row">
										...
										<div class="form-row">
											<?php echo form_dropdown('catalogue[]', '', (isset($catalogue)?$catalogue:NULL), 'class="form-control " multiple="multiple" data-title="Nhập 2 kí tự để tìm kiếm.."  style="" id="project_catalogue"'); ?>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="ibox-content">
							<div class="row">
								<div class="col-lg-12">
									...
									<div class="form-row">
										<?php echo form_dropdown('url_view', $this->configbie->data('url_detail_view'), set_value('url_view'), 'class="form-control m-b select3"');?>
									</div>
								</div>
							</div>
						</div>
