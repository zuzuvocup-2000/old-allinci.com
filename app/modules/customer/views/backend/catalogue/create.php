<div id="page-wrapper" class="gray-bg dashbard-1">
	<div class="row border-bottom">
	 ...
	 <div class="row wrapper border-bottom white-bg page-heading">
		<div class="col-lg-10">
			<h2>Thêm mới nhóm khách hàng</h2>
			<ol class="breadcrumb">
				<li>
					<a href="<?php echo site_url('admin'); ?>">Home</a>
				</li>
				<li class="active"><strong>Thêm mới nhóm khách hàng</strong></li>
			</ol>
		</div>
	</div>
									...
									<div class="row">
										<div class="col-lg-12">
											...
											<div class="uk-flex uk-flex-right">
												<div class="uk-button">
													<button style="margin-right:2px;" class="btn btn-primary btn-sm" name="create" value="create" type="submit">Khởi tạo nhóm khách hàng mới</button>
