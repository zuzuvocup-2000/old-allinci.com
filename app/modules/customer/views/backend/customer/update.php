							...
							<div class="row mb15">
								<div class="col-lg-6">
									<div class="form-row">
										...
										<?php echo form_input('account', htmlspecialchars_decode(html_entity_decode(set_value('account', $detailCustomer['account']))), 'class="form-control" readonly="true" placeholder="" autocomplete="off"');?>
										<?php echo form_hidden('account_original', htmlspecialchars_decode(html_entity_decode(set_value('account_original', $detailCustomer['account']))), 'class="form-control" readonly="true" placeholder="" autocomplete="off"');?>
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-row">
