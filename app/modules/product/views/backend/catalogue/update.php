<div id="page-wrapper" class="gray-bg dashbard-1 fix-wrapper">
	...
	<div class="row wrapper border-bottom white-bg page-heading">
		<div class="col-lg-10">
			<h2>Cập nhật danh mục sản phẩm</h2>
			<ol class="breadcrumb">
				<li>
					<a href="<?php echo site_url('admin'); ?>">Home</a>
				</li>
				<li class="active"><strong>Cập nhật danh mục sản phẩm</strong></li>
			</ol>
		</div>
	</div>
								...
								<div class="col-lg-12">
									...
									<?php
										...
										if(isset($album) && is_array($album) && count($album)){
											...
											$gallery = json_decode($detailCatalogue['image_json'], TRUE);
										}
									?>
					...
					<div class="ibox mb20">
						...
						<div class="ibox-content">
							<div class="row">
								<div class="col-lg-12">
									<div class="form-row">
										<select name="article[]" data-json="<?php echo base64_encode($article) ?>" data-condition="" class="form-control selectMultipe filter" multiple="multiple" data-title="Nhập 2 kí tự để tìm kiếm theo bài viết.." data-module="media"  style="width:100%"></select>
