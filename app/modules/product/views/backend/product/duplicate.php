...
<div id="page-wrapper" class="gray-bg dashbard-1 fix-wrapper">
	...
	<form method="post" action="" class="form-horizontal box" >
		...
		<div class="row wrapper border-bottom white-bg page-heading">
			<div class="col-lg-10">
				<h2>Tạo mới sản phẩm</h2>
				<ol class="breadcrumb">
					<li>
						<a href="<?php echo site_url('admin'); ?>">Home</a>
					</li>
					<li class="active"><strong>Tạo mới sản phẩm</strong></li>
				</ol>
			</div>
		</div>
			...
			<div class="row">
						...
						<div class="ibox-content">
							<div class="row">
								...
								<div class="col-lg-6 m-b">
									...
									<div class="form-row">
										<?php echo form_input('price_sale', set_value('price_sale', addCommas($product['price_sale']),0), 'class="form-control int" placeholder="đ" autocomplete="off"');?>
									</div>
								</div>
							</div>
							<div class="row">
										...
										<div class="col-lg-3 ">
											<div class="image_color m-b-xs" style="cursor: pointer;">
												<div class="image_small" style=" background: <?php echo $val['color'] ?>">
														<img  src="<?php echo getthumb($image_color[$key]) ?>"  alt="">
												</div>
										...
										<?php foreach ($title_version as $key => $value) {?>
											<tr>
												<td>
													...
													<div class="uk-flex uk-flex-middle">
														<div class="image mr5">
															<div class="avatar" style="cursor: pointer;"><img src="<?php echo getthumb($image_version[$key]) ?>" class="img-thumbnail" alt=""></div>
															<input type="text" name="image_version[]" value="<?php echo getthumb($image_version[$key]) ?>" class="hidden" onclick="openKCFinder(this)" >
															</div>
													</div>
												</td>
										...
										<div class="form-row">
											...
											<div class="outer">
												<div class="uk-flex uk-flex-middle">
													...
													<?php echo form_input('canonical', htmlspecialchars_decode(html_entity_decode(set_value('canonical', $product['canonical']))), 'class="form-control canonical" placeholder="" autocomplete="off" data-flag="1" ');?>
												</div>
											</div>
										</div>
									</div>
				...
				<div class="col-lg-4">
					...
					<div class="ibox mb20">
						...
						<div class="ibox-content">
							<div class="row">
								<div class="col-lg-12">
									<div class="form-row">
										<?php echo form_input('landing_view', htmlspecialchars_decode(html_entity_decode(set_value('landing_view', (isset($product['landing_view']) ? $product['landing_view'] : '')))), 'class="form-control" placeholder="" autocomplete="off"');?>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="ibox mb20">
						<div class="ibox-title uk-flex uk-flex-middle uk-flex-space-between">
							<h5>Tags </h5>
							<a type="button" data-toggle="modal" data-target="#myModal6"> + Tạo mới tag</a>
						</div>
						<div class="ibox-content">
							<div class="row">
								<div class="col-lg-12">
