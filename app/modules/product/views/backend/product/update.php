...
<div id="page-wrapper" class="gray-bg dashbard-1 fix-wrapper">
	...
	<form method="post" action="" class="form-horizontal box" >
		...
		<script type="text/javascript">
			...
			var cityid = '<?php
				if($this->input->post('update')){
					echo ($this->input->post('cityid'))? $this->input->post('cityid'): '';
				}else{
					echo isset($product['cityid'])? $product['cityid']: '';
				}
			?>';
			var districtid = '<?php
				if($this->input->post('update')){
					echo ($this->input->post('districtid'))? $this->input->post('districtid'): '';
				}else{
					echo isset($product['districtid'])? $product['districtid']: '';
				}
			?>';
			
			var wardid = '<?php
				if($this->input->post('update')){
					echo ($this->input->post('wardid'))? $this->input->post('wardid'): '';
				}else{
					echo isset($product['wardid'])? $product['wardid']: '';
				}
			?>';
		</script>
					...
					<div class="ibox mb20">
						...
						<div class="ibox-content">
							<div class="row">
								<div class="col-lg-12">
									<div class="form-row">
										<?php echo form_input('landing_link', htmlspecialchars_decode(html_entity_decode(set_value('landing_link', $product['landing_link']))), 'class="form-control" placeholder="" autocomplete="off"');?>
									</div>
								</div>
							</div>
						</div>
