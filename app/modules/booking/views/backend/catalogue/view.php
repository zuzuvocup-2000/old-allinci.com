				...
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						...
						<div class="ibox-tools">
							...
							<ul class="dropdown-menu dropdown-booking">
								<li><a type="button" class="ajax_delete_booking_all" data-title="Lưu ý: Hãy chắc chắn rằng bạn muốn thực hiện chức năng này!" data-module="booking">Xóa tất cả</a>
								</li>
							</ul>
							<a class="close-link">
						...
						<div class="table-responsive">
							<div class="uk-flex uk-flex-middle uk-flex-space-between">
								<div class="perpage">
									<div class="uk-flex uk-flex-middle mb10">
										<?php echo form_dropdown('perpage', $this->configbie->data('perpage'), set_value('perpage',$this->input->get('perpage')) ,'class="form-control input-sm perpage filter"  data-url="'.site_url('booking/backend/catalogue/view').'"'); ?>
									</div>
								</div>
								<div class="toolbox">
									<div class="uk-flex uk-flex-middle uk-flex-space-between">
										...
										<div class="uk-button">
											<a href="<?php echo site_url('booking/backend/catalogue/create'); ?>" class="btn btn-danger"><i class="fa fa-plus"></i> Thêm lịch mới</a>
										</div>
									</div>
								</div>
							</div>
							...
							<table class="table table-striped table-bordered table-hover dataTables-example" >
								...
								<tbody id="ajax-content">
									<?php if(isset($bookingList) && is_array($bookingList) && count($bookingList)){ ?>
										<?php foreach($bookingList as $key => $val){ ?>
											<tr class="gradeX" id="cat-<?php echo $val['id']; ?>">
												...
												<td>Chi tiết lịch ngày: <?php echo gettime($val['date'], 'd-m-Y'); ?></td>
												...
												<td class="text-center">
													<a type="button" href="<?php echo site_url('booking/backend/catalogue/update/'.$val['id'].'') ?>" class="btn btn-primary"><i class="fa fa-edit"></i></a>
													<a  type="button" class="btn btn-danger ajax_delete_booking" data-title="Lưu ý: Khi bạn xóa danh mục, toàn bộ lịch trong nhóm này sẽ bị xóa. Hãy chắc chắn rằng bạn muốn thực hiện hành động này!" data-router="" data-id="<?php echo $val['id'] ?>" data-module="booking" data-child=""><i class="fa fa-trash"></i></a>
												</td>
											</tr>
										<?php }}else{ ?>
											<tr>
