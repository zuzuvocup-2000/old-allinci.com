	...
	<div class="row wrapper border-bottom white-bg page-heading">
		<div class="col-lg-10">
			...
			<ol class="breadcrumb">
				...
				<li class="active"><strong>Cập nhật Menu</strong></li>
			</ol>
		</div>
	</div>
								...
								<div class="col-lg-12">
									<div class="form-row">
										...
										<?php 
											...
											echo form_dropdown('catalogueid', $listCat, set_value('catalogueid', $detailNavigation['id']), 'class="form-control m-b select3"');
										?>
									</div>
								</div>
							</div>
							...
							<div class="menu-list">
								...
								<?php 
									$listMenu = $this->Autoload_Model->_get_where(array(
										...
										'table' => 'navigation',
										'where' => array('catalogueid' => $detailNavigation['id']),
										'order_by' => 'order desc',
									), TRUE);
								?>
